...
function AnimUtils:clearEntity(entity)
	entity.trackMods = nil
	entity.raceTrackMods = nil
	entity.animationGroupIndexMap = nil
end
...
function AnimUtils:animate(entity, data)
	...
	-- print("ANIMATING: ", entity.name, race, animationClass, animationId)
